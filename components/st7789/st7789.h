...
#define APRICOT       rgb565(255, 188, 154)   // warm peach highlight
#define MOONLIGHT_GRAY rgb565(217, 217, 217)  // soft moon hazy gray

#define ORANGE        rgb565(255, 140,   0)
#define PURPLE        rgb565(160,  32, 240)
#define LAVENDER      rgb565(181, 126, 220)
#define SKY_BLUE      rgb565(135, 206, 235)
#define PINK          rgb565(255, 105, 180)
